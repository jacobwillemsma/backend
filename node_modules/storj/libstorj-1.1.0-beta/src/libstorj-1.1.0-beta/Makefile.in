...
CONFIG_CLEAN_FILES = libstorj.pc
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/libstorj.pc.in \
...
$(am__aclocal_m4_deps):
libstorj.pc: $(top_builddir)/config.status $(srcdir)/libstorj.pc.in
